...
import com.sk.buildingmanagement.Event_activity;
...
public class GridView_Adapter extends BaseAdapter
{
    ...
    public GridView_Adapter(Context mainActivity, String[] prgmNameList, int[] prgmImages)
    {
    ...
    public View getView(final int position, View convertView, ViewGroup parent)
    {
        ...
        rowView = inflater.inflate(R.layout.home_fragment_grid_adapter_layout, null);
        ...
        holder.img.setOnClickListener(new OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                if(result[position].equalsIgnoreCase("EVENTS"))
                {
